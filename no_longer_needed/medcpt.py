...
with weaviate.connect_to_custom(
    ...
    for key, value in dict_rs.items():
        ...
        embeds = embed_model(chunks, tokenizer, model)
        weaviate_embeds = F.normalize(embeds, p=2, dim=1)
